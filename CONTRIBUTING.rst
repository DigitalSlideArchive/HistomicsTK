...
Report bugs at https://github.com/cdeepakroy/histomicstk/issues.
...
The best way to send feedback is to file an issue at https://github.com/cdeepakroy/histomicstk/issues.
...
3. The pull request should work for Python 2.6, 2.7, 3.3, 3.4 and 3.5, and for PyPy. Check
   https://travis-ci.org/cdeepakroy/histomicstk/pull_requests
...
To run a subset of tests::
    ...
    $ python -m unittest tests.test_histomicstk
