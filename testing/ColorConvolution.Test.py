#Tests ColorConvolution.py. Uses a standard H&E calibration matrix to deconvolve
#a test image into hematoxylin and eosin stains, uses these stains to recompose
#the color image and each stain, and then displays the original and recomposed 
#images side-by-side.
