...
.. automodule:: histomicstk.annotations_and_masks
    :members:
    :undoc-members:
    :show-inheritance:
...
.. toctree::
    ...
    Tips for scalable annotation rendering for developers <Tips_for_scalable_annotation_rendering_for_developers.rst>
