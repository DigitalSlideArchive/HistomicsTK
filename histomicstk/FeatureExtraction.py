...
def FeatureExtraction(Label, I, K=128, Fs=6, Delta=8):
    ...
    Delta : int
        scalar, used to dilate nuclei and define cytoplasm region.
        Default value = 8.
    ...
    CytoplasmEnergyGradMag	CytoplasmSkewnessGradMag
    CytoplasmKurtosisGradMag CytoplasmSumCanny	CytoplasmMeanCanny
