...
void trace_boundary_cpp::rot90(int nrows, int ncols, std::vector <std::vector<int> > matrix,
...
std::vector <std::vector<int> > trace_boundary_cpp::isbf(int nrows, int ncols, std::vector <std::vector<int> > mask, int startX, int startY, float inf)
{
...
std::vector <std::vector<int> > trace_boundary_cpp::moore(int nrows, int ncols, std::vector <std::vector<int> > mask, int startX, int startY, float inf)
{
    // initialize boundary vector
    std::list<int> boundary_listX;
    std::list<int> boundary_listY;
