#Tests ColorDeconvolution.py. Uses a standard H&E calibration matrix to deconvolve
#a test image into hematoxylin and eosin stains, then displays the intensity 
#images of these stains with the original.
