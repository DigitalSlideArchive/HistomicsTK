...
*Related functions:
	RudermanLABFwd
*References:
	“Statistics of Cone Responses to Natural Images: Implications for Visual Coding,” J. Optical Soc. of America, vol. 15, no. 8, 1998, pp. 2036-2045.
'''
...
I = numpy.transpose(I.reshape(m*n,3))
